...
def get_openai_response(model, user_role, user_content,RFP = 0):
    print("API 호출 중")
...
def fine_tuning_summary(*rfp_files):
    for rfp_file in rfp_files:
        ...
        return resulting_json_dict
        # # Specify the file path
        # output_file_path = f"./domain/rfp/summary/output/output_{rfp_name}.json"
